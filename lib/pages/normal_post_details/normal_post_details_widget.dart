...
class NormalPostDetailsWidget extends StatefulWidget {
  const NormalPostDetailsWidget({
    super.key,
    String? selectedRepo,
  ...
  @override
  State<NormalPostDetailsWidget> createState() =>
      _NormalPostDetailsWidgetState();
}

class _NormalPostDetailsWidgetState extends State<NormalPostDetailsWidget> {
  late NormalPostDetailsModel _model;
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              context.pushNamed('choose_repository');
            },
          ),
          actions: const [],
          centerTitle: false,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Flexible(
                            child: Text(
                              'What specific task(s) did you accomplish today?',
                                ...
                                fieldViewBuilder: (
                                  ...
                                  return TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          'e.g., finished the login functionality',
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Flexible(
                            child: Text(
                              'What did you learn from the task(s)  accomplished?',
                              style: FlutterFlowTheme.of(context)
                                  .titleSmall
                                  .override(
                                    fontFamily: 'Montserrat',
                              ...
                              fieldViewBuilder: (
                                ...
                                return TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    isDense: true,
                                    hintText:
                                        'e.g., learned how to use \'X\' library effectively',
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          fontFamily: 'Outfit',
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Flexible(
                            child: Text(
                              'Did you face any challenges in accomplishing the task(s) above?',
                              style: FlutterFlowTheme.of(context)
                                  .titleSmall
                                  .override(
                                    fontFamily: 'Montserrat',
                                  ...
                                  fieldViewBuilder: (
                                    ...
                                    return TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            'e.g., encountered CORS issues during API integration',
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily: 'Outfit',

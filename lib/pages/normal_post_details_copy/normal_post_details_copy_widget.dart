...
import 'normal_post_details_copy_model.dart';
export 'normal_post_details_copy_model.dart';

class NormalPostDetailsCopyWidget extends StatefulWidget {
  const NormalPostDetailsCopyWidget({
    super.key,
    String? selectedRepo,
  ...
  @override
  State<NormalPostDetailsCopyWidget> createState() =>
      _NormalPostDetailsCopyWidgetState();
}

class _NormalPostDetailsCopyWidgetState
    extends State<NormalPostDetailsCopyWidget> {
  late NormalPostDetailsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NormalPostDetailsCopyModel());

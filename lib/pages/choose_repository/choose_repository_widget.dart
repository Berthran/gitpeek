...
class _ChooseRepositoryWidgetState extends State<ChooseRepositoryWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: GetRepositoriesCall.call(),
      builder: (context, snapshot) {
        ...
        final chooseRepositoryGetRepositoriesResponse = snapshot.data!;
            ...
            body: SafeArea(
              ...
              child: Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    FFAppState().repo = _model.selectedRepositoryValue!;
                    safeSetState(() {});
                  },
                  child: Column(
                      ...
                      Padding(
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final selectedRepositoryGetRepositoriesResponse =
                                snapshot.data!;

                            return FlutterFlowDropDown<String>(
                              controller:
                                  _model.selectedRepositoryValueController ??=
                                      FormFieldController<String>(
                                _model.selectedRepositoryValue ??= 'NULL',
                              ),
                              options: GetRepositoriesCall.repositories(
                                selectedRepositoryGetRepositoriesResponse
                                    .jsonBody,
                              )!,
                              onChanged: (val) async {
                                safeSetState(() =>

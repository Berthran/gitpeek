...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    gitpeekAuthUserSubject.add(
      GitpeekAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<GitpeekAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  GitpeekAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = GitpeekAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    gitpeekAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
